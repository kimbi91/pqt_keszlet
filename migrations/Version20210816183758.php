 ...
 */
final class Version20210816183758 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock CHANGE phone phone LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock CHANGE phone phone INT NOT NULL');
    }
}
